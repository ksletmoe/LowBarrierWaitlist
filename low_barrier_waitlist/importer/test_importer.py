...
if __name__ == "__main__":
    ...
    for p in participants:
        low_barrier_waitlist.persistence.update_participant(
            db, p, low_barrier_waitlist.persistence.get_import_attributes()
        )
    ...
    for rp in r.ranked_participants[:200:]:
        print(
            "ID: {} (Rank: {} [age: {}, vet: {}, dis: {})".format(
                rp.participant.hmis,
                rp.rank,
                rp.participant.age,
                rp.participant.veteran,
                rp.participant.disability_status,
            )
        )
